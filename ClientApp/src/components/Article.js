    ...
    <>
      {loading ? (
        ...
        <>
            ...
            {articles.map((a) => {
              return (
                <div key={a.id}>
                    ...
                    <div className="card-body">
                      ...
                      <div className="card-actions justify-end">
                        <button
                          ...
                          onClick={(e) => modalAction(e, a.id, "show")}
                        >
                          打开
                        </button>
                      </div>
                  ...
                  <dialog
                    id={`article_modal_${a.id}`}
                    className="modal backdrop-blur-sm"
                  >
                    <form
                      method="dialog"
                      className="w-4/5 h-4-5 lg:w-2/3 lg:h-2/3"
                    >
                      <div className="card card-compact bg-base-100 shadow-xl">
                        <div className="card-body">
                          <h2 className="card-title">{a.title}</h2>
                          ...
                          <div>
                            ...
                            <div className="card-actions justify-end">
                              <button
                                ...
                                onClick={(e) => modalAction(e, a.id, "close")}
                              >
                                关闭
                              </button>
                            </div>
          ...
          <button
            className="btn btn-neutral fixed bottom-4 right-4"
            onClick={(e) => modalAction(e, "create", "show")}
          >
            新增
          </button>
          <dialog
            id={`article_modal_create`}
            className="modal backdrop-blur-sm"
          >
            <form
              method="dialog"
              className="w-4/5 h-4-5 lg:w-2/3 lg:h-2/3"
              onSubmit={(e) => pushArticle(e)}
            >
              <div className="card card-compact bg-base-100 shadow-xl">
                <div className="card-body">
                  ...
                  <div className="card-actions justify-end">
                    ...
                    <button
                      className="btn btn-accent"
                      type="button"
                      onClick={(e) => modalAction(e, "create", "close")}
                    >
                      取消
                    </button>
                  </div>
