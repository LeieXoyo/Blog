...
export const NavMenu = props => {
  ...
  return (
    <div className="navbar sticky top-0 z-20 backdrop-blur-sm">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
            <li><Link to="/music">商羽</Link></li>
            <li><Link to="/game">星弈</Link></li>
            <li><Link to="/article">书墨</Link></li>
            <li><Link to="/image">丹青</Link></li>
          </ul>
        </div>
      </div>
      <div className="navbar-center">
        <Link to="/" className="btn btn-ghost normal-case text-xl">板栗御用铲屎官的博客</Link>
      </div>
      <div className="navbar-end">
        <label className="btn btn-circle swap swap-rotate">
          <input id="playMusic" type="checkbox" onInput={(e) => ToggleMusicState(e)} />
          <svg className="swap-off fill-current w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <svg className="swap-on fill-current w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        ...
        <label className="btn btn-circle swap swap-rotate">
          <input id='changeTheme' type="checkbox" onInput={(e) => ToggleTheme(e)} />
